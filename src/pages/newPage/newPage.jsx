    ...
    render() {
        return (
            <div id="newPage">
                ...
                {intl.get('editor.item.headerTitleF')} 
                 </div>
                {/* 图片 */}
                ...
                <div className="intelligenceCenter">
                    <div className="wrap">
                        ...
                        <div className="rightI">
                            <div className="fistR">
                                <h2> 	{intl.get('editor.item.headerTitleF')} </h2>


                                <span className="spanLeft">{intl.get('editor.item.forth_content')} </span><span className="spanRight"></span>
                            </div>
                            <div>

                            <div>
                                <h2> 	{intl.get('editor.item.forth_content1')}</h2>

                                <span className="spanLeft">{intl.get('editor.item.forth_content2')} </span><span className="spanRight">

                                </span>

                            </div>
                                <h2> 	{intl.get('editor.item.forth_content3')} </h2>

                                <span className="spanLeft">
                                {intl.get('editor.item.forth_content4')}    
...
Object.assign(newPage.prototype, {
    componentDidMount() {
